export default function AuthorsLoading() {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="h-10 w-48 bg-border/50 rounded animate-pulse mb-2" />
      <div className="h-5 w-64 bg-border/30 rounded animate-pulse mb-8" />
        ...
        <div className="flex-1 grid sm:grid-cols-2 xl:grid-cols-3 gap-4">
          {Array.from({ length: 6 }).map((_, i) => (
            <div key={i} className="bg-card rounded-lg border border-border p-5">
              ...
              <div className="h-4 w-24 bg-border/20 rounded animate-pulse mt-2" />
